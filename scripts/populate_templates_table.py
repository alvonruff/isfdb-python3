...
##                print template, url, displayed, mouseover
                insert = """insert into
                                        ...
                                        values('%s', '%s', 'External URL', '%s', '%s')""" % (CNX.DB_ESCAPE_STRING(template_name),
        ...
        for template_name in sorted(internal_links):
                ...
                insert = """insert into
                                        templates(template_name, template_display, template_type, template_url, template_mouseover)
                                        values('%s', '%s', 'Internal URL', '%s', '%s')""" % (CNX.DB_ESCAPE_STRING(template_name),
                                                                                                                           CNX.DB_ESCAPE_STRING(template_display),
                                                                                                                           CNX.DB_ESCAPE_STRING(template_url),
                                                                                                                           CNX.DB_ESCAPE_STRING(template_mouseover))
                if debug == 0:
        ...
        for template_name in sorted(substitute_templates):
                ...
                insert = """insert into
                                        templates(template_name, template_display, template_type, template_url, template_mouseover)
                                        values('%s', '%s', 'Substitute String', '%s', '%s')""" % (CNX.DB_ESCAPE_STRING(template_name),
                                                                                                                           CNX.DB_ESCAPE_STRING(template_display),
                                                                                                                           CNX.DB_ESCAPE_STRING(template_url),
                                                                                                                           CNX.DB_ESCAPE_STRING(template_mouseover))
                if debug == 0:
